      ...
      <section>
        <form class="form-signin pr-5 pt-3 pb-3 pl-5 border rounded bg-light" method="POST">
          <div class="separador mb-0">
            <img class="mb-3" src=" <?php echo base_url(); ?>assets/image/LogoSatelite.png" alt="" width="70" height="85"/>
          </div>
          <div class="mt-1 mb-1 text-muted">
            ...
            <div class="text-left form-group">
              ...
              <div class="mt-4">
                ...
                <input type="submit" name="commit" value="INICIAR SESIÓN" class="btn btn-info btn-block my-4 font-weight-bold"
